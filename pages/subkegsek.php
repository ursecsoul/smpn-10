...
<body>
  <div class="galeri-header">
    <h2>Galeri Foto</h2>
    <p>Kegiatan siswa-siswi SMPN 10 Malang</p>
  </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="foto-container">
          <img src="salim.jpg" class="foto" alt="Foto 1">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="tanam.jpg" class="foto" alt="Foto 2">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="pramuka.jpg" class="foto" alt="Foto 3">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="ngaji.jpeg" class="foto" alt="Foto 4">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="covid.jpg" class="foto" alt="Foto 5">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="kolompok.jpg" class="foto" alt="Foto 6">
        </div>
      </div>
    </div> -->
<?php
...
// Query untuk mengambil foto dengan kategori "kegiatan"
$sql = "SELECT * FROM photos WHERE kategori = 'kegiatan'";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo '        <img src="' . htmlspecialchars($row['gambar']) . '" class="foto" alt="Gambar Kegiatan">';
      echo '    </div>';
