...
<body>
  <div class="galeri-header">
    <h2>Galeri Foto</h2>
    <p>Masa Pengenalan Lingkungan Sekolah</p>
  </div>
    ...
    <div class="row">
      <!-- <div class="col-md-4">
        <div class="foto-container">
          <img src="10.jpg" class="foto" alt="Foto 1">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="mplstutup.jpg" class="foto" alt="Foto 2">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="mplspra.jpg" class="foto" alt="Foto 3">
        </div> -->
...
$sql = "SELECT * FROM photos WHERE kategori = 'MPLS'";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo '        <img src="' . htmlspecialchars($row['gambar']) . '" class="foto" alt="Gambar MPLS">';
      echo '    </div>';
  ...
  echo "<p class='text-center'>Tidak ada foto dalam kategori 'mpls'.</p>";
}
?>
      </div>
