...
// Query untuk mengambil foto dengan kategori "guru"
$sql = "SELECT * FROM photos WHERE kategori = 'guru'";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo '        <img src="' . htmlspecialchars($row['gambar']) . '" class="foto" alt="Gambar Guru">';
      echo '    </div>';
