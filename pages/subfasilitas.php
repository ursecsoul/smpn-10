    ...
    <div class="row">
      <div class="col-md-4">
        <div class="foto-container">
          <img src="uks.jpeg" class="foto" alt="Foto 1">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="lapangan.jpg" class="foto" alt="Foto 2">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="fli.png" class="foto" alt="Foto 3">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="lab.jpeg" class="foto" alt="Foto 4">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="perpustakaan.jpg" class="foto" alt="Foto 5">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="masjid.jpeg" class="foto" alt="Foto 6">
        </div>
      </div>
    </div>
    <?php
...
// Query untuk mengambil foto dengan kategori "fasilitas sekolah"
$sql = "SELECT * FROM photos WHERE kategori = 'fasilitas_sekolah'";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo '        <img src="' . htmlspecialchars($row['gambar']) . '" class="foto" alt="Gambar fasilitas_sekolah">';
      echo '    </div>';
