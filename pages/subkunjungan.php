    ...
    <div class="row">
      <div class="col-md-4">
        <div class="foto-container">
          <img src="kunjungan.jpeg" class="foto" alt="Foto 1">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="MAN2.jpeg" class="foto" alt="Foto 2">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="smp2.jpg" class="foto" alt="Foto 3">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="kunjungann.jpeg" class="foto" alt="Foto 4">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="kunjungan33.jpg" class="foto" alt="Foto 5">
        </div>
      </div>

      <div class="col-md-4">
        <div class="foto-container">
          <img src="kunjungansmp.jpg" class="foto" alt="Foto 6">
        </div>
      </div>
    </div>
    <?php
...
// Query untuk mengambil foto dengan kategori "kunjungan"
$sql = "SELECT * FROM photos WHERE kategori = 'kunjungan'";
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo '        <img src="' . htmlspecialchars($row['gambar']) . '" class="foto" alt="Gambar kunjungan">';
      echo '    </div>';
